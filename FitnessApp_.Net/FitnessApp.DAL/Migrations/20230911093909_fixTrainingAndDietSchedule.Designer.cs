...
namespace FitnessApp.DAL.Migrations
{
    ...
    [Migration("20230911093909_fixTrainingAndDietSchedule")]
    partial class fixTrainingAndDietSchedule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessApp.Models.TrainingAndDietSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FitnessApp.Models.Diet", b =>
                {
                    ...
                    b.HasOne("FitnessApp.Models.TrainingAndDietSchedule", "TrainingAndDietSchedule")
                        .WithMany("Diets")
